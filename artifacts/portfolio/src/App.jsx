...
function Nav() {
  ...
  // Listen for scroll events and update state with a smooth transition
  useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    <div
      ...
      className="transition-all inset-hover dark:bg-[#2d2d2d] bg-[#e5e5e5] z-10"
    >
      {/* Full-page menu transition */}
      <div
        className={`fixed top-0 left-0 w-full h-full bg-[#e5e5e5] dark:bg-[#2d2d2d] transform transition-transform duration-300 z-50 ${
        ...
        <div className="p-8 text-center text-3xl sm:text-5xl font-bold z-50">
          <ul>
            <li>
              <a
                href="/"
                className="block py-4 text-gray-900 dark:text-white hover:text-blue-600 my-2 mt-20 sm:mt-10 mx-10 sm:mx-44 hover:bg-skyblue-100 dark:hover:bg-[#2d2d2d]"
              >
                Home
                <span className="block neumorphism-inset h-2 w-full mt-5" />
              </a>
            </li>
            <li>
              <a
                href="/about"
                className="block py-4 text-gray-900 dark:text-white hover:text-blue-600 my-2 mx-10 sm:mx-44"
              >
                About Me
                <span className="block neumorphism-inset h-2 w-full mt-5" />
              </a>
      ...
      <div className="dark:bg-[#2d2d2d] bg-[#e5e5e5]">
        ...
        <div
          className={`fixed top-6 right-6 space-y-4 z-50 neumorphism p-2 sm:flex sm:flex-col sm:space-y-5 sm:space-x-4 dark:bg-[#2d2d2d] bg-[#e5e5e5] transition-all duration-500 ${
            !showFloatingButtons ? "opacity-0 translate-y-[-20px]" : "opacity-100 translate-y-0"
          }`}
        >
          {/* Hamburger Icon */}
          <button
